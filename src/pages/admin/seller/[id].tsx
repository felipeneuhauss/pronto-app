...
import { Input, Select, SubTitle, Toggle } from 'components/Form'
import AppLayout from 'components/Layouts/AppLayout'
import { revertMapping, SellerEntity, SellerMapped, sellerMapper } from 'shared/mappers'
...
const Seller = () => {
  ...
  const { register, handleSubmit, reset, setValue } = useForm<SellerMapped>({
    defaultValues: { }
  })
        ...
        <div className={'p-5'}>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              ...
              <Input label={'Telefone'} name={'phone'} register={register} required={true} />
            </div>
            <SubTitle>Endereço</SubTitle>
            <Address address={seller?.address} register={register} setValue={setValue} />
            <div className={'py-4 border-t-2 mt-2'}>
              <Toggle label={'Inativar usuário'} setValue={setValue} {...register}
                name={'inactivate'} checked={!!seller?.deletedAt} />
            </div>
